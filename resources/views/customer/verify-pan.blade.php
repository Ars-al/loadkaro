                ...
                <div class="loginbox">
                    ...
                    <div class="login-right">
                        <div class="login-right-wrap">
                            ...
                            <!-- Form -->
                            <form id="pan-form" action="{{ route('customer.verify.pan', ["id" => $customer->id]) }}" method="POST">
                                @csrf
                                <div class="mb-3">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#pan-form').on('submit', function(event) {
                ...
                // Send AJAX request
                $.ajax({
                    url: "{{ route('customer.verify.pan', ["id" => $customer->id]) }}",
                    method: "POST",
                    data: formData,
                    success: function(response) {
                        if (response.success) {
                            ...
                            $('#success-alert').show();
                            window.location.href = '{{ route('customer.aadhaar.verify.page', ["id" => $customer->id]) }}';
                        } else {

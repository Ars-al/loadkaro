                                    ...
                                    <div class="form-group col-6">
                                        <div class="form-floating mb-3">
                                            <select name="type" class="form-control floating-input" id="type"
                                                ...
                                                <option value="48">Trailer 4923</option>
                                                <option value="31">Truck 25MT / 14 wheel</option>
                                                <option value="40">Truck 20MT / 12 wheel</option>
                                                <option value="43">Truck 21MT / 12 wheel</option>
                                            </select>

                ...
                <div class="loginbox">
                    ...
                    <div class="login-right">
                        <div class="login-right-wrap">
                            ...
                            <!-- Form -->
                            <form id="rc-form" action="{{ route('transporter.verify.rc') }}" method="POST">
                                @csrf
                                <div class="mb-3">
                                    <label for="rc_number" class="form-label">Enter RC Number</label>
                                    <input type="text" max="10" name="rc_number"
        ...
        <div class="login-wrapper">
            <div class="container">
                <div class="loginbox">
                    ...
                    <div class="login-right">
                        <div class="login-right-wrap">
                            <h1 class="mb-4">Vehicle RC Verification</h1>
                            ...
                            <form id="rc-form" action="{{ route('transporter.verify.rc') }}" method="POST">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" name="rc_number" id="rc_number" class="form-control" placeholder=" " required>
                                    <label for="rc_number">Enter RC Number</label>
                                </div>
                                <button type="submit" class="btn btn-primary w-100">Verify</button>
                            </form>
                            <!-- /Form -->
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#rc-form').on('submit', function(event) {
                ...
                // Send AJAX request
                $.ajax({
                    url: "{{ route('transporter.verify.rc') }}",
                    method: "POST",
                    data: formData,
